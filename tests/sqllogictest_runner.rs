...
// ============================================================================
// Individual SLT test functions (generated by build.rs)
//
// Each .test file gets its own #[tokio::test] function, so:
// - Individual tests can be re-run: `cargo test slt_ducklake_basic`
// - A panic in one test doesn't prevent others from running
// - Test output shows which specific file failed
// ============================================================================

include!(concat!(env!("OUT_DIR"), "/slt_tests.rs"));
